      ...
      <div className="p-4 rounded-3xl bg-white border border-slate-200/80 shadow-sm flex flex-wrap items-center justify-between gap-4 shrink-0">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-emerald-50 text-emerald-700 border border-emerald-200">
                {isRunning ? 'Simulácia prebieha' : 'Pozastavené / Ukončené'}
              </span>
            </div>
            <p className="text-xs text-slate-500">Prebieha autonómna simulácia trhu s viacerými agentmi</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 text-xs">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-2xl bg-slate-50 border border-slate-200/70">
            ...
            <div>
              <span className="text-[10px] text-slate-400 block font-semibold uppercase">Simulovaný čas</span>
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-2xl bg-slate-50 border border-slate-200/70">
            ...
            <div>
              <span className="text-[10px] text-slate-400 block font-semibold uppercase">Rozdelenie postojov</span>
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-2xl bg-slate-50 border border-slate-200/70">
            ...
            <div>
              <span className="text-[10px] text-slate-400 block font-semibold uppercase">Virálna odozva</span>
