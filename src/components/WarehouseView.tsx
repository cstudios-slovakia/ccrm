        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-4 xl:col-span-4 space-y-4">
            ...
            <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-sm space-y-4 relative">
              ...
              {/* Client picker — the app-wide one, so this reads and behaves
                  exactly like every other lead/client dropdown. */}
              <ClientSelect
                leads={leads}
                value={issueLeadId}
                onChange={setIssueLeadId}
                noneLabel={t("Direct Sale / Unassigned Client", "Priamy predaj / Bez priradenia k zákazníkovi", "Közvetlen eladás")}
